...
/***
 generate a postgresSql native query with the given filter:
 query params : jalaliYear , month , productType
 return a table with the following columns:

 table columns:
 customerName: Aggregate all small customers ( bigCustomer = false ) in one row under Other,
 totalAmount: total amount of sales in the month,
 totalQuantity: total quantity of sales in the month,
 cumulativeTotalQuantity : total quantity of sales in the month and previous months,
 cumulativeTotalAmount: total amount of sales in the month and previous months,
 avgUnitPrice: average unit price of sales in the month,
 relativePercentage: relative percentage of sales in the month compared to total sales
